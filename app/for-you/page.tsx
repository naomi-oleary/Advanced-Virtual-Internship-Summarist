        ...
        <div>
           ...
           <section className="px-8 py-4">
                ...
                {Array.isArray(selectedBook) && selectedBook.map((book) => (
                    <div key={book.id}>{book.keyIdeas}</div>
                ))}
                    {/* // <div key={selectedBook.id} className="flex flex-col bg-amber-500/15 p-8 rounded-sm">
                    //     <p>{selectedBook.keyIdeas}</p>
                    //     <div className="flex mt-6">
                    //         <img src={selectedBook.imageLink} className="h-35 max-w-35" />
